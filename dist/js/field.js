...
Nova.booting(function (Vue, router) {
    Vue.component('index-plain-text', __webpack_require__(3));
    Vue.component('detail-plain-text', __webpack_require__(6));
    Vue.component('form-plain-text', __webpack_require__(9));
});
      ...
      _c("template", { slot: "field" }, [
        _vm.text === "checkbox"
          ? _c("input", {
              ...
              staticClass:
                "w-full form-control form-plain-text text-80 h-9 pt-2 ml-3",
              attrs: {
